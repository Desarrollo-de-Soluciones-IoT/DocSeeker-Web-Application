...
@Component({
  selector: 'app-patients-list-services',
  templateUrl: './patients-list-services.component.html',
  styleUrls: ['./patients-list-services.component.css']
})
export class PatientsListServicesComponent {
